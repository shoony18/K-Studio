//
//  premiumSelectedMyPostEditViewController.swift
//  track_online
//
...
class premiumSelectedMyPostEditViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    func download(){
        ...
        let textVideo:String = self.selectedPostID!+".mp4"
    ...
    @IBAction func resendQA(_ sender: Any) {
        ...
        let defaultAction: UIAlertAction = UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler:{
            ...
            let ref0 = self.Ref.child("purchase").child("premium").child("uuid").child("\(self.currentUid)").child("post").child("\(self.selectedPostID!)")
            let ref1 = self.Ref.child("purchase").child("premium").child("post").child("\(self.selectedPostID!)")
