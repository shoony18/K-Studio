...
//            let fcmTokenStatus = ["fcmTokenStatus":"1"]
//            let dbRef = Database.database().reference()
//            dbRef.child("fcmToken").child(currentUid).updateChildValues(fcmTokenStatus)
//        }else{
//            self.profileNotification.text = "OFF"
//            let fcmTokenStatus = ["fcmTokenStatus":"0"]
//            let dbRef = Database.database().reference()
//            dbRef.child("fcmToken").child(currentUid).updateChildValues(fcmTokenStatus)
//        }
//
//    }
    ...
    func profile(){
        ...
        let ref = Database.database().reference().child("QA").child("uuid").child("\(currentUid)")
